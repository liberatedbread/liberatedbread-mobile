...
|---|---|---|
| `bridge.*` | `001788fffe61fcb0` | the bridge itself: right CN, gets pinned |
| `impostor.*` | `001788fffe61fcb0` | a different device wearing the right CN — caught by the pin, not the CN |
...
openssl req -x509 -newkey rsa:2048 -keyout bridge.key -out bridge.crt \
  -days 36500 -nodes -subj "/CN=001788fffe61fcb0"
```
