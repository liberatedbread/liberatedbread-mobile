...
void main() {
  ...
  test('refuses to fetch anything but https', () async {
    ...
    expect(
      await service.fetch('http://liberatedbread.com/app/banner.json'),
  ...
  test(
    'stops an oversized download mid-stream when no length is declared',
    () async {
