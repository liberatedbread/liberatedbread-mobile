...
void main() {
  ...
  testWidgets('a combined-packet entity picks its own field out of the record '
  ...
  testWidgets(
    'renders an OFFSET scaling from a vendored spec, not raw counts',
    (tester) async {
      ...
      final entity = gerbing.entities.firstWhere(
        (e) => e.name == 'Temperature 1',
      );
