...
void main() {
  ...
  testWidgets('a spec that never subscribes still reads a notify-only '
  ...
  testWidgets('a failed subscription surfaces an error instead of an eternal '
  ...
  testWidgets('applies a scale declared on the format field', (tester) async {
    ...
    await tester.pumpWidget(
      _wrap(_tempEntity(), _codecReturning(2350, scale: 0.01)),
    );
    await tester.pumpAndSettle();
  ...
  testWidgets('entity scale wins over the format field scale', (tester) async {
    ...
    await tester.pumpWidget(
      _wrap(_tempEntity(scale: 0.01), _codecReturning(5320, scale: 0.1)),
    );
    await tester.pumpAndSettle();
  ...
  group('verdict chips', () {
    ...
    testWidgets('a radon reading past the red line says Poor', (tester) async {
      ...
      await tester.pumpWidget(
        _wrap(entity(unit: 'Bq/m³'), _codecReturning(180)),
      );
      await tester.pumpAndSettle();
    ...
    testWidgets('a healthy air reading says Good out loud', (tester) async {
      await tester.pumpWidget(
        _wrap(entity(deviceClass: 'humidity', unit: '%'), _codecReturning(45)),
      );
      await tester.pumpAndSettle();
    ...
    testWidgets('a healthy battery keeps quiet; a low one warns', (
      ...
      await tester.pumpWidget(
        _wrap(entity(deviceClass: 'battery', unit: '%'), _codecReturning(85)),
      );
      await tester.pumpAndSettle();
      ...
      await tester.pumpWidget(
        _wrap(entity(deviceClass: 'battery', unit: '%'), _codecReturning(15)),
      );
      await tester.pumpAndSettle();
      expect(find.text('Fair'), findsOneWidget);
    });
