...
void main() {
  ...
  test('rangeFor falls back to the natural range of the type', () {
    ...
    expect(rangeFor('int32', null, null), (
      min: -2147483648.0,
      max: 2147483647.0,
    ));
  ...
  test(
    'rangeFor falls back to a safe range for degenerate/inverted bounds',
    () {
  ...
  test(
    'divisionsFor returns step count or null for wide/degenerate ranges',
    () {
  ...
  test(
    'allowedEntryLabel pairs label with wire value, or shows value alone',
    () {
  ...
  test('displayValueFor/rawValueFor are inverse across the presentation '
      'transform', () {
