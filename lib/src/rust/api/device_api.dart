...
Future<int?> lifxReplySequence({required List<int> datagram}) =>
    RustLib.instance.api.crateApiDeviceApiLifxReplySequence(datagram: datagram);
...
class HttpHeaderDto {
  ...
  const HttpHeaderDto({required this.name, required this.value});
